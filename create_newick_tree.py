...
def make_newick_tree(marker_fasta, tree_outfile):
    ...
    # print "return_code1", return_code
    if return_code !=0:
        print "You will have a problem creating file .ph"
        if return_code == 255:
            print "You have same genome name"
        if return_code == 127:
            raise ImportError ("Import can't find module clustalw, please install it")
